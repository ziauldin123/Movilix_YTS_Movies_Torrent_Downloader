...
import com.movilix.torrant.core.model.data.metainfo.BencodeFileItem;
...
import com.movilix.torrant.core.utils.TorrentContentFileTreeUtils;
...
public class DetailTorrentViewModel extends AndroidViewModel {
    ...
    public com.movilix.torrant.ui.detailtorrent.TorrentDetailsMutableParams mutableParams = new com.movilix.torrant.ui.detailtorrent.TorrentDetailsMutableParams();
    ...
    public void clearData() {
        ...
        info.addOnPropertyChangedCallback(infoCallback);
        mutableParams.removeOnPropertyChangedCallback(mutableParamsCallback);
        mutableParams = new com.movilix.torrant.ui.detailtorrent.TorrentDetailsMutableParams();
        mutableParams.addOnPropertyChangedCallback(mutableParamsCallback);
        fileTree = null;
        treeLeaves = null;
    }
