...
import com.movilix.databinding.FragmentFeedBinding;
import com.movilix.torrant.ui.BaseAlertDialog;
import com.movilix.torrant.ui.addfeed.AddFeedActivity;
...
public class FeedFragment extends Fragment
        implements com.movilix.torrant.ui.feeds.FeedChannelListAdapter.ClickListener
{
    ...
    private com.movilix.torrant.ui.feeds.FeedChannelListAdapter adapter;
    private LinearLayoutManager layoutManager;
    /* Save state scrolling */
    private Parcelable feedListState;
    private SelectionTracker<com.movilix.torrant.ui.feeds.FeedChannelItem> selectionTracker;
    private ActionMode actionMode;
    private FragmentFeedBinding binding;
    private com.movilix.torrant.ui.feeds.FeedViewModel viewModel;
    private com.movilix.torrant.ui.feeds.MsgFeedViewModel msgViewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = provider.get(com.movilix.torrant.ui.feeds.FeedViewModel.class);
        msgViewModel = provider.get(com.movilix.torrant.ui.feeds.MsgFeedViewModel.class);
        dialogViewModel = provider.get(BaseAlertDialog.SharedViewModel.class);

        adapter = new com.movilix.torrant.ui.feeds.FeedChannelListAdapter(this);
        /*
        ...
        selectionTracker = new SelectionTracker.Builder<>(
                ...
                binding.feedList,
                new com.movilix.torrant.ui.feeds.FeedChannelListAdapter.KeyProvider(adapter),
                new com.movilix.torrant.ui.feeds.FeedChannelListAdapter.ItemLookup(binding.feedList),
                StorageStrategy.createParcelableStorage(com.movilix.torrant.ui.feeds.FeedChannelItem.class))
                .withSelectionPredicate(SelectionPredicates.createSelectAnything())
                .build();

        selectionTracker.addObserver(new SelectionTracker.SelectionObserver<com.movilix.torrant.ui.feeds.FeedChannelItem>() {
            @Override
        ...
        return viewModel.observerAllFeeds()
                ...
                .flatMapSingle((feedList) ->
                        Flowable.fromIterable(feedList)
                                .map(com.movilix.torrant.ui.feeds.FeedChannelItem::new)
                                .toList()
                )
    ...
    private void subscribeMsgViewModel()
    {
        ...
        disposables.add(msgViewModel.observeFeedsDeleted()
                .filter((ids) -> {
                    com.movilix.torrant.ui.feeds.FeedChannelItem item = adapter.getOpenedItem();
                    if (item == null)
                        return false;
    ...
    @Override
    public void onItemClicked(@NonNull com.movilix.torrant.ui.feeds.FeedChannelItem item)
    {
        if (Utils.isTwoPane(activity))
    ...
    {
        MutableSelection<com.movilix.torrant.ui.feeds.FeedChannelItem> selections = new MutableSelection<>();
    ...
    private void copyChannelUrl()
    {
        ...
        Iterator<com.movilix.torrant.ui.feeds.FeedChannelItem> it = selections.iterator();
        if (!it.hasNext())
            return;
    ...
    private void refreshSelectedFeeds()
    {
        ...
        int i = 0;
        for (com.movilix.torrant.ui.feeds.FeedChannelItem selection : selections)
            ids[i++] = selection.id;
