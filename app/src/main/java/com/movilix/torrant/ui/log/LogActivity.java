...
import com.movilix.databinding.ActivityLogBinding;
...
public class LogActivity extends AppCompatActivity
    implements com.movilix.torrant.ui.log.LogAdapter.ClickListener
{
    ...
    private com.movilix.torrant.ui.log.LogAdapter adapter;
    private Handler handler;
    private boolean ignoreScrollEvent;
    private boolean autoScroll = true;
    private int scrollPosition = 0;
    private CompositeDisposable disposables = new CompositeDisposable();
    private com.movilix.torrant.ui.log.SessionLogFilterDialog filterDialog;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        filterDialog = (com.movilix.torrant.ui.log.SessionLogFilterDialog) fm.findFragmentByTag(TAG_FILTER_DIALOG);
        ...
        viewModel = new ViewModelProvider(this).get(com.movilix.torrant.ui.log.LogViewModel.class);
        ...
        adapter = new com.movilix.torrant.ui.log.LogAdapter(this);
    ...
    private void showFilterDialog()
    {
        ...
        if (fm.findFragmentByTag(TAG_FILTER_DIALOG) == null) {
            filterDialog = com.movilix.torrant.ui.log.SessionLogFilterDialog.newInstance();
    ...
    {
        startActivity(new Intent(this, com.movilix.torrant.ui.log.LogSettingsActivity.class));
    }
