...
public class AboutAlertDialog extends DialogFragment
{
    ...
    private static final String TAG = AboutAlertDialog.class.getSimpleName();
    ...
    public static AboutAlertDialog newInstance(String title, String message, int resIdView,
                                               String positiveText, String negativeText,
                                               String neutralText, boolean autoDismiss)
    {
        AboutAlertDialog frag = new AboutAlertDialog();
                                      ...
                                      boolean autoDismiss)
    {
        ...
        titleView.setText("About Movilix");
        titleView.setGravity(Gravity.CENTER);
        titleView.setPadding(20, 20, 20, 20);
        titleView.setTextSize(20F);
        titleView.setTypeface(Typeface.DEFAULT_BOLD);
        titleView.setBackgroundColor(ContextCompat.getColor(getActivity(), R.color.colorPrimaryDark));
        titleView.setTextColor(ContextCompat.getColor(getActivity(), R.color.background));
