...
import com.movilix.databinding.DialogCreateTorrentBinding;
...
public class CreateTorrentDialog extends DialogFragment
{
    ...
    private com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel viewModel;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        viewModel = provider.get(com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel.class);
    ...
    private void initAlertDialog(View view)
    {
        ...
        alert.setOnShowListener((DialogInterface dialog) -> {
            ...
            viewModel.getState().observe(this, (state) -> {
                if (state.status == com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel.BuildState.Status.BUILDING) {
                ...
                if (state.status == com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel.BuildState.Status.FINISHED)
                    handleFinish();

                else if (state.status == com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel.BuildState.Status.ERROR)
    ...
    private void handleBuildError(Throwable err)
    {
        ...
        if (err instanceof com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel.InvalidTrackerException) {
            binding.layoutTrackerUrls.setErrorEnabled(true);
            binding.layoutTrackerUrls.setError(getString(R.string.invalid_url,
                    ((com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel.InvalidTrackerException)err).url));
            binding.layoutTrackerUrls.requestFocus();

        } else if (err instanceof com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel.InvalidWebSeedException) {
            binding.layoutWebSeedUrls.setErrorEnabled(true);
            binding.layoutWebSeedUrls.setError(getString(R.string.invalid_url,
                    ((com.movilix.torrant.ui.createtorrent.CreateTorrentViewModel.InvalidWebSeedException)err).url));
