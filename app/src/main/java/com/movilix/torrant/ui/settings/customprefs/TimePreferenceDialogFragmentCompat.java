...
/**
 * The Dialog for the {@link com.movilix.torrant.ui.settings.customprefs.TimePreference}.
 *
...
public class TimePreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat
{
    ...
    protected void onBindDialogView(View view)
    {
        ...
        if (preference instanceof com.movilix.torrant.ui.settings.customprefs.TimePreference) {
            minutesAfterMidnight = ((com.movilix.torrant.ui.settings.customprefs.TimePreference) preference).getTime();
        }
    ...
    public void onDialogClosed(boolean positiveResult)
    {
        if (positiveResult) {
            ...
            DialogPreference preference = getPreference();
            if (preference instanceof com.movilix.torrant.ui.settings.customprefs.TimePreference) {
                com.movilix.torrant.ui.settings.customprefs.TimePreference timePreference = ((com.movilix.torrant.ui.settings.customprefs.TimePreference) preference);
