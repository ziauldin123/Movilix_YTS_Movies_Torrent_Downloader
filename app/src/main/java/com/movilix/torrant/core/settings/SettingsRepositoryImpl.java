...
package com.movilix.torrant.core.settings;
...
public class SettingsRepositoryImpl implements com.movilix.torrant.core.settings.SettingsRepository
{
    private static class Default
    {
        ...
        static int theme(@NonNull Context context) { return Integer.parseInt(context.getString(R.string.pref_theme_dark_value)); }
        ...
        /* Network settings */
        static final int portRangeFirst = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PORT_RANGE_FIRST;
        static final int portRangeSecond = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PORT_RANGE_SECOND;
        ...
        static final boolean anonymousMode = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_ANONYMOUS_MODE;
        static final boolean seedingOutgoingConnections = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_SEEDING_OUTGOING_CONNECTIONS;
        /* Limitations settings */
        static final int maxDownloadSpeedLimit = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_DOWNLOAD_RATE_LIMIT;
        static final int maxUploadSpeedLimit = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_UPLOAD_RATE_LIMIT;
        static final int maxConnections = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_CONNECTIONS_LIMIT;
        static final int maxConnectionsPerTorrent = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_CONNECTIONS_LIMIT_PER_TORRENT;
        static final int maxUploadsPerTorrent = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_UPLOADS_LIMIT_PER_TORRENT;
        static final int maxActiveUploads = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_ACTIVE_SEEDS;
        static final int maxActiveDownloads = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_ACTIVE_DOWNLOADS;
        static final int maxActiveTorrents = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_ACTIVE_LIMIT;
        static final boolean autoManage = false;
        /* Proxy settings */
        static final int proxyType = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PROXY_TYPE.value();
        static final String proxyAddress = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PROXY_ADDRESS;
        static final int proxyPort = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PROXY_PORT;
        static final boolean proxyPeersToo = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PROXY_PEERS_TOO;
        static final boolean proxyRequiresAuth = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PROXY_REQUIRES_AUTH;
        static final String proxyLogin = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PROXY_LOGIN;
        static final String proxyPassword = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_PROXY_PASSWORD;
        ...
        /* Logging settings */
        static final boolean logging = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_LOGGING;
        static final int maxLogSize = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_MAX_LOG_SIZE;
        static final boolean logSessionFilter = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_LOG_SESSION_FILTER;
        static final boolean logDhtFilter = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_LOG_DHT_FILTER;
        static final boolean logPeerFilter = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_LOG_PEER_FILTER;
        static final boolean logPortmapFilter = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_LOG_PORTMAP_FILTER;
        static final boolean logTorrentFilter = com.movilix.torrant.core.settings.SessionSettings.DEFAULT_LOG_TORRENT_FILTER;
    }
    ...
    @Override
    public com.movilix.torrant.core.settings.SessionSettings readSessionSettings()
    {
        com.movilix.torrant.core.settings.SessionSettings settings = new com.movilix.torrant.core.settings.SessionSettings();
        ...
        settings.encryptMode = com.movilix.torrant.core.settings.SessionSettings.EncryptMode.fromValue(encryptMode());
        ...
        settings.proxyType = com.movilix.torrant.core.settings.SessionSettings.ProxyType.fromValue(proxyType());
