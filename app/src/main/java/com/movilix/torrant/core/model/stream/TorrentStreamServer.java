...
import com.movilix.nanohttpd.NanoHTTPD;
...
import static com.movilix.nanohttpd.NanoHTTPD.Response.Status.BAD_REQUEST;
import static com.movilix.nanohttpd.NanoHTTPD.Response.Status.FORBIDDEN;
import static com.movilix.nanohttpd.NanoHTTPD.Response.Status.NOT_FOUND;
import static com.movilix.nanohttpd.NanoHTTPD.Response.Status.NOT_MODIFIED;
import static com.movilix.nanohttpd.NanoHTTPD.Response.Status.OK;
import static com.movilix.nanohttpd.NanoHTTPD.Response.Status.PARTIAL_CONTENT;
import static com.movilix.nanohttpd.NanoHTTPD.Response.Status.RANGE_NOT_SATISFIABLE;
...
public class TorrentStreamServer extends NanoHTTPD
{
    ...
    public Response handleTorrent(IHTTPSession httpSession)
    {
        ...
        int fileIndex;
        com.movilix.torrant.core.model.stream.TorrentStream stream;
        try {
        ...
        try {
            ...
            if (headerIfRangeMissingOrMatching && range != null &&
                ...
                if (headerIfNoneMatchPresentAndMatching) {
                    ...
                    com.movilix.torrant.core.model.stream.TorrentInputStream is = engine.getTorrentInputStream(stream);
                    is.skip(startFrom);
