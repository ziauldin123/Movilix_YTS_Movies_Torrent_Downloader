...
import com.movilix.feedparser.FeedType;
...
class FeedHandler extends DefaultHandler {
    ...
    private Stack<com.movilix.feedparser.impl.BaseElement> elementStack;
    private Feed feed;
    ...
    public void startDocument() throws SAXException {
        super.startDocument();
        elementStack = new Stack<com.movilix.feedparser.impl.BaseElement>();
    }
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        com.movilix.feedparser.impl.BaseElement newElement;
        
        if (RDF.equalsIgnoreCase(localName)) {
            // Create feed for RSS 1.0.
            com.movilix.feedparser.impl.Rss1Feed newFeed = new com.movilix.feedparser.impl.Rss1Feed(uri, RDF, attributes);
            feed = newFeed;
            ...
            com.movilix.feedparser.impl.AtomFeed newFeed = new com.movilix.feedparser.impl.AtomFeed(uri, FEED, attributes);
            feed = newFeed;
            ...
            // Create Atom item.
            newElement = new com.movilix.feedparser.impl.AtomItem(uri, localName, attributes);

        } else {
            // Create new XML element.
            newElement = new com.movilix.feedparser.impl.BaseElement(uri, localName, attributes);
        }
    ...
    public void endElement(String uri, String localName, String qName)
        ...
        com.movilix.feedparser.impl.BaseElement currentElement = elementStack.pop();
        ...
        if (!elementStack.empty()) {
            com.movilix.feedparser.impl.BaseElement parent = elementStack.peek();
